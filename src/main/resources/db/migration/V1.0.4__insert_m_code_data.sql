...
('AUDIT_STAGE','STAGE_INTERNAL','ISO27001_2022','内部監査','IntAudit','0','1','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
...
-- ROLE (extension3=canInternalAudit)
('ROLE','ADMIN','DEFAULT','管理者','Admin','1','4','true',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('ROLE','USER','DEFAULT','一般ユーザー','User','0','2','false',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
