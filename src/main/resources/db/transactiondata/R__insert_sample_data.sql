...
('RTP006','RSK006','オフサイトバックアップ、耐震設備DR計画','USR004','2025-05-01','OPEN'),
('RTP007','RSK007','ログ監視、外部通信制度整備','USR003','2025-05-05','OPEN'),
...
('RTP012','RSK012','S3権限棚卨、MFA管理、クラウド診断','USR004','2025-06-05','OPEN'),
('RTP013','RSK013','EDR導入、メール添付検疫、オフラインバックアップ','USR003','2025-06-10','OPEN'),
('RTP014','RSK014','外部委託先にセキュリティ要件組込、NDA厳格化','USR003','2025-06-15','OPEN'),
('RTP015','RSK015','SNS多要素認証、投稿事前認可、脆弱連絡体制','USR005','2025-06-20','OPEN'),
('RTP016','RSK016','SNSガイドライン、発信抑止ルール、承認規定','USR005','2025-06-25','OPEN'),
